...
export const DashboardSidebar = component$(() => {
  return (
    <>
      <aside class="flex flex-col w-24 md:w-64 h-screen px-4 overflow-y-auto bg-white border-r rtl:border-r-0 rtl:border-l dark:bg-gray-900 dark:border-gray-700">
        <div class="flex flex-col justify-between flex-1 mt-6">
          <nav>
            ...
            >
              ...
              <span class="hidden md:block mx-4 font-medium">Dashboard</span>
            </a>
            <a
            ...
            >
              ...
              <span class="hidden md:block mx-4 font-medium">Settings</span>
            </a>
          </nav>
        </div>
      </aside>
