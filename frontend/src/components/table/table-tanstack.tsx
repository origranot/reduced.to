...
// // export const { getSerializable, useSerializable } = makeSerializable(
// //   $((serState: { number: number }) => {
// //     const theClass = new MyClass(serState.number);
// //     // It is important that when the class state changes, you reflect that in your own state
// //     // which will be used to restore the class in the future if needed.
// //     theClass.handleChanges((newNum) => {
// //       serState.number = newNum;
// //     });
// //     return theClass;
// //   })
// // );
...
//   const { getSerializable, useSerializable } = makeSerializable(
//     $((state: any) => {
//       // $((serState: Table<T>) => {
//       // const theClass = new MyClass(serState.number);
//       // // It is important that when the class state changes, you reflect that in your own state
...
//       // });
//       // return theClass;
//       return generateUseTable(columns as ColumnDef<T, unknown>[], props.rows as T[])(state);
//     })
//   );
...
//               onClick$={async () => {
//                 const table = await getSerializable(state);
