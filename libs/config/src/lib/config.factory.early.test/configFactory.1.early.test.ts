...
describe('configFactory() configFactory method', () => {
  ...
  describe('Happy Path', () => {
    beforeEach(() => {
      ...
      process.env.KAFKA_PASSWORD = 'kafka_pass';
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle non-numeric values for numeric environment variables gracefully', () => {
      process.env.BACKEND_APP_PORT = 'not-a-number';
      process.env.FRONTEND_APP_PORT = 'not-a-number';
      process.env.RATE_LIMIT_TTL = 'not-a-number';
      process.env.RATE_LIMIT_COUNT = 'not-a-number';
    ...
    it('should handle boolean environment variables correctly', () => {
      process.env.PADDLE_ENABLE = 'false';
      process.env.REDIS_ENABLE = 'false';
      process.env.KAFKA_ENABLE = 'false';
      process.env.STORAGE_ENABLE = 'false';
      process.env.SAFE_URL_ENABLE = 'false';
