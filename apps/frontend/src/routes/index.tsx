          ...
          <div class="col-start-2 col-end-12 md:col-start-3 md:col-end-11">
            <div class="flex flex-col">
              <article class="prose mx-auto max-w-4xl pb-16">
                <div class="mx-auto">
                {globalStore.theme === 'light' ? <img class="mx-auto" src="logoLight.svg" width="410" height="73" alt="Logo" /> : <img class="mx-auto" src="logoDark.svg" width="410" height="73" alt="Logo" />}
                </div>
                <p>
