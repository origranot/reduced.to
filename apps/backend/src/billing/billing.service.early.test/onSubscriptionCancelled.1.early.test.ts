...
describe('BillingService.onSubscriptionCancelled() onSubscriptionCancelled method', () => {
  ...
  it('should successfully cancel a subscription and delete it from the database', async () => {
    // Arrange
  ...
  it('should not delete subscription if user does not exist', async () => {
    // Arrange
    const mockEvent = new MockSubscriptionCanceledEvent();
  ...
  it('should not delete subscription if user has no subscription', async () => {
    // Arrange
    const mockEvent = new MockSubscriptionCanceledEvent();
    mockPrismaService.user.findUnique.mockResolvedValue({
      id: 'mock-user-id',
